...
function paramsToFilters(p: URLSearchParams): CardSearchParams {
  return {
    ...
    mana_cost_op: (p.get('mana_cost_op') ?? 'eq') as CardSearchParams['mana_cost_op'],
    power: p.get('power') ?? '',
    power_op: (p.get('power_op') ?? 'eq') as CardSearchParams['power_op'],
    toughness: p.get('toughness') ?? '',
    toughness_op: (p.get('toughness_op') ?? 'eq') as CardSearchParams['toughness_op'],
    sort_by: (p.get('sort_by') ?? 'name') as CardSearchParams['sort_by'],
